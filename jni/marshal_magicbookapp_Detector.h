 ...
 * Signature: (II)V
 */
JNIEXPORT void JNICALL Java_marshal_magicbookapp_Detector_setSize
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_marshal_magicbookapp_Detector_init
  (JNIEnv *, jobject);
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_marshal_magicbookapp_Detector_clear
  (JNIEnv *, jobject);
